...
addTechBtn.addEventListener('click', function (ev) {
    ...
    const tetechNameInput = createInput('techName-' + rowIndex, null, 'techName')
    ...
    newRow.append(
        techNameLabel, tetechNameInput, expLabel, expRadio1, expLabel1, expRadio2, expLabel2, expRadio3, expLabel3, removeRowBtn
    )
